-- =====================================================
-- Script tạo bảng Log (chạy thủ công nếu database đã tồn tại)
-- =====================================================
-- Chạy script này nếu database đã tồn tại và bạn muốn thêm bảng log
-- Hoặc nếu bảng log chưa được tạo tự động
